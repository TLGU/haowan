...
//    self.systemPageCtrl.frame = CGRectMake(0, self.height  - 20 - 40, self.width, 40);
     self.systemPageCtrl.frame = CGRectMake(0, self.height  - 20 , self.width, 20);
...
//    [self.systemPageCtrl addTarget:self action:@selector(pageControlAction:) forControlEvents:UIControlEventValueChanged];
    self.systemPageCtrl.currentPageIndicatorTintColor=[UIColor blackColor];
    self.systemPageCtrl.pageIndicatorTintColor=[UIColor groupTableViewBackgroundColor];

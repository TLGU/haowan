...
@interface Artist_CommentListVC ()

@end

@implementation Artist_CommentListVC
...
- (void)viewDidLoad {
    ...
    void (^loadData)(BOOL isRefresh )=^(BOOL isRefresh){
        [weakSelf loadDataWithDataType:DataTypeList_Artist andId:@"推荐" scrollView:weakSelf.tableView isRefresh:isRefresh finish:^(id value) {
            if ([value boolValue]) {
